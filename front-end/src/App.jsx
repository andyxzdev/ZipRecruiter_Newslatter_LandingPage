...
import Img_forms from "./assets/images/img_forms.png";
        ...
        <div className="pt-40 lg:pt-0 text-center lg:text-left">
          ...
          <div className="mt-6 space-y-7 2xl:w-[100%]">
            <motion.h1
              ...
              viewport={{ once: true }}
              className="text-4xl 2xl:text-[4rem] font-bold text-[#45DB61]"
            >
            ...
            <motion.h3
              ...
              viewport={{ once: true }}
              className="text-base text-white max-w-xl"
            >
        ...
        <div>
          <div className="text-center">
            <motion.h1
              ...
              transition={{ delay: 0.6, duration: 0.5 }}
              viewport={{ once: true }}
              className="text-[2.5rem] lg:text-[3rem] xl:text-[3.5rem] font-bold text-[#002325]"
            >
              Stay Informed.
              <br />
              Stay Ahead.
          ...
          <div className="lg:mt-15 lg:flex lg:items-center lg:justify-evenly lg:gap-5">
            ...
            >
              <div>
                <Earth size={45} className="text-[#45DB61]" />
              </div>
              <div className="pt-3">
                <h1 className="text-[1.4rem] text-white font-bold">
                  Salary Insights That Matter
            ...
            >
              <div>
                <Rocket size={45} className="text-[#45DB61]" />
              </div>
              <div className="pt-3">
                <h1 className="text-[1.4rem] text-white font-bold">
                  Salary Insights That Matter
        ...
        <div className="flex flex-col items-center lg:flex-row gap-20">
          <div className="lg:w-[50%]">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h1 className="text-[2rem] lg:text-[2.5rem] xl:text-[3rem] 2xl:text-[4rem] text-[#002325] font-bold">
                Take the Next Step in Your Career
              </h1>
              <h2 className="text-[1rem] pt-3 pb-3">
              ...
              <div className="flex flex-col">
                <div className="flex gap-8">
                  <div className="flex items-center gap-4 mt-6">
                    <BriefcaseBusiness size={38} className="text-[#45DB61]" />
                  ...
                  <div className="flex items-center gap-4 mt-6">
                    <TrendingUp size={40} className="text-[#45DB61]" />
                    <p className="lg:text-[0.8rem]">
                ...
                <div className="flex items-center gap-4 mt-6">
                  <GraduationCap size={40} className="text-[#45DB61]" />
          ...
          <div className="hidden md:block">
            <div className="w-full">
              <img src={Img_forms} alt="" className="lg:ml-60 w-[80%]" />
            </div>
          </div>
        </div>
      </section>
